...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT :: ANSWER; i have moved it all over and named it diffrent things.  i see no resone it will not change to let/const or move. as it is not a number string coolean null or undefined "let" should be the assigning charicter
